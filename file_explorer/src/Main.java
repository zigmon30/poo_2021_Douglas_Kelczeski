		...
		while(true){
			...
			if(opecao == 2){
				for(int indexDis = 0; indexDis < numDispositivo; indexDis++){
					println("Dispositivo[" + indexDis + "]: " + dispositivos[indexDis].nome + dispositivos[indexDis].capacidade 
							+ dispositivos[indexDis].capacidadeUsada + dispositivos[indexDis].getCapacidadeRestante());
				}
			}
		}
